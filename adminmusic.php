...
<body onload="MM_preloadImages('images/pm4.jpg','images/musicadd.png')">
<table width="1024" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td rowspan="7" valign="top" bgcolor="#000000"><!--DWLayoutEmptyCell-->&nbsp;</td>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','1014','height','80','src','images/bar2','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','images/bar2' ); //end AC code
    ...
    <td rowspan="6" valign="top" bgcolor="#000000"><!--DWLayoutEmptyCell-->&nbsp;</td>
  </tr>
  <tr>
    <td height="30"></td>
    <td></td>
  ...
  <tr>
    <td height="60">&nbsp;</td>
    <td>&nbsp;</td>
    <td valign="top"><a href="insertmusic1.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','images/musicadd.png',1)"><img src="images/musicadd.png" name="Image4" width="150" height="80" border="0" id="Image4" /></a></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td height="194">&nbsp;</td>
    <td>&nbsp;</td>
    <td><span class="style1">ADD MUSIC</span></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
