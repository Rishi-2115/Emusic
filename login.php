...
<body onload="MM_preloadImages('images/newmu.jpg','images/instru.jpg')">
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','1014','height','80','src','images/bar2','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','images/bar2' ); //end AC code
  ...
  <tr>
    <td height="100"></td>
    <td colspan="3" align="center" valign="middle" class="style2" id="td">Welcome To eMusic</td>
    <td></td>
    <td></td>
  </tr>
  ...
  <tr>
    <td height="60"></td>
    <td valign="top"><a href="playmusic.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image2','','images/play.png',1)"><img src="images/newmu.jpg" name="Image2" width="150" height="80" border="0" id="Image2" /></a></td>
    <td>&nbsp;</td>
    <td valign="top"><a href="shopinst2.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image3','','images/1.png',1)"><img src="images/instru.jpg" name="Image3" width="150" height="80" border="0" id="Image3" /></a></td>
    <td></td>
    <td></td>
  </tr>
