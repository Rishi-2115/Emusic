...
<body onload="MM_preloadImages('images/pm4.jpg','images/ip2.jpg','images/dp2.jpg','images/up2.jpg')">
<table width="1024" border="0" align="center" cellpadding="0" cellspacing="0">
  <!--DWLayoutTable-->
  <tr>
    <td height="80" colspan="12" valign="top"><img src="images/newbanner.jpg" width="1024" height="150" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td height="80" colspan="10" valign="top"><script type="text/javascript">
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','1014','height','80','src','images/bar2','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','images/bar2' ); //end AC code
  ...
  <tr>
    <td height="100"></td>
    <td colspan="5" align="center" valign="middle" class="style2" id="td">Administrator Account</td>
    <td></td>
    <td></td>
    <td></td>
    <td></td>
  ...
  <tr>
    <td height="60"></td>
    <td valign="top"><a href="insertproduct.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','images/ip2.jpg',1)"><img src="images/ip1.jpg" name="Image4" width="120" height="60" border="0" id="Image4" /></a></td>
    <td>&nbsp;</td>
    <td valign="top"><a href="updateproduct1.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image5','','images/up2.jpg',1)"><img src="images/up1.jpg" name="Image5" width="120" height="60" border="0" id="Image5" /></a></td>
    <td>&nbsp;</td>
    <td valign="top"><a href="deleteproduct.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image3','','images/dp2.jpg',1)"><img src="images/dp1.jpg" name="Image3" width="120" height="60" border="0" id="Image3" /></a></td>
    <td></td>
    <td></td>
    <td></td>
    <td></td>
