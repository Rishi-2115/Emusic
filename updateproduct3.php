...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','1014','height','80','src','images/bar2','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','images/bar2' ); //end AC code
  ...
  <tr>
	...
	if(isset($_POST['submit']))
	{
		...
		$update=mysqli_query($con,"update instrument set instrumentname='{$instrumentname}',instrumentprice={$instrumentprice},feature1='{$feature1}',feature2='{$feature2}',feature3='{$feature3}',feature4='{$feature4}',productdescription='{$productdescription}',brand='{$brand}',weight={$weight},productdimension='{$productdimensions}' where productid=$productid");
		...
		{
			echo "<h2><font color=#AA2D5F>Product not Updated</font></h2>";
		}
